// Generated by CoffeeScript 1.8.0
  var BackgroundLayer, Detect, Errors, Layer, Utils, ease, easeIn, easeInOut, easeOut, easeReverse, idArray, linear, screenHeight, screenWidth;
  ...
  Layer = (function() {
    ...
    Layer.prototype.animates = function(event, x, time, curve) {
      switch (event) {
        case 'opacity':
          $('#' + this.name).velocity({
            opacity: x
